...
export class ArticleService {
    ...
    async addToFavoriteArticle(slug: string, currentUserId: number):Promise<IArticleResponse> {
        ...
        const isNotFavorite = !user?.favorites.find(article => article.id === currentArticle.id);
        if (isNotFavorite) {
